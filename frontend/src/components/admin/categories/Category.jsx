...
const Category = () => {
     ...
     const onDeleteHandler = () => {
          dispatch(deleteCategoryDashboardAction(setOpenDeleteModal, selectedCategory?.id, toast));
     };
     ...
     return (
          <div>
               ...
               {!emptyCategories && <h1 className='text-slate-800 text-3xl text-center font-bold pb-6 uppercase'>All Categories</h1>}
