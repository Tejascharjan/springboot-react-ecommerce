...
const AdminProducts = () => {
     ...
     return (
          <div>
               ...
               {!emptyProduct && <h1 className='text-slate-800 text-3xl text-center font-bold pb-6 uppercase'>All Products</h1>}
               ...
               <Modal open={openImageUploadModal} setOpen={setOpenImageUploadModal} title='Add Product Image'>
                    <ImageUploadForm setOpen={setOpenImageUploadModal} product={selectedProduct} isAdmin={isAdmin} />
               </Modal>
               ...
               <ProductViewModal open={openProductViewModal} setOpen={setOpenProductViewModal} product={selectedProduct} />
          </div>
     );
};
