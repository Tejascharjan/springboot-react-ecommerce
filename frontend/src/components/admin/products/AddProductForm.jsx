...
const AddProductForm = ({ setOpen, product, update = false, isAdmin = false }) => {
          ...
          <div className='py-5 relative h-full'>
               <form className='space-y-4' onSubmit={handleSubmit(saveProductHandler)}>
                    <div className='flex md:flex-row flex-col gap-4 w-full'>
                         ...
                         {!update && (
                              <SelectTextField label='Select Category' select={selectedCategory} setSelect={setSelectedCategory} lists={categories} />
                         )}
                    </div>
                    <div className='flex md:flex-row flex-col gap-4 w-full'>
                         <InputField
                    ...
                    <div className='flex flex-col gap-2 w-full'>
                         ...
                         {errors["description"]?.message && (
                              <p className='text-sm font-semibold text-red-600 mt-0'>{errors["description"]?.message}</p>
                         )}
                    </div>
