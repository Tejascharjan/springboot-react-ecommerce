     ...
     return (
          <div>
               <div className='flex md:flex-row mt-8 flex-col lg:justify-between border border-slate-400 rounded-lg bg-linear-to-r from-blue-50 to-blue-100 shadow-lg'>
                    ...
                    <DashboardOverview title={"Total Order"} amount={totalOrders} Icon={FaShoppingCart} />
                    <DashboardOverview title={"Total Revenue"} amount={totalRevenue} Icon={FaRupeeSign} revenue />
               </div>
          </div>
     );
};
