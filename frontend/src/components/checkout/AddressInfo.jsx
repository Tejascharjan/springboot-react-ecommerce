...
const AddressInfo = ({address}) => {
     ...
     const addNewAddressHandeler = () => {
          setSelectedAddress("");
          setOpenAddressModal(true);
     };

     const dispatch = useDispatch();
     const deleteAddressHandeler = () => {
          ...
          <div className='pt-4'>
               {noAddressExist ? (
                    <div className='p-6 rounded-lg max-w-md mx-auto flex flex-col items-center justify-center'>
                         ...
                         <p className='mb-6 text-slate-800 text-center'>Please add your address to complete pirchase</p>
                         <button
                              onClick={addNewAddressHandeler}
                         ...
                         {isLoading ? (
                              ...
                              <>
                                   ...
                                   {address.length > 0 && (
                                        <div>
                                             <button
                                                  className='px-4 py-2 bg-blue-600 text-white font-medium rounded hover:bg-blue-700 transition-all mt-4'
                                                  onClick={addNewAddressHandeler}>
                                                  Add More
                                             </button>
                                        </div>
               ...
               <DeleteModal
                    ...
                    onDeleteHandler={deleteAddressHandeler}
               />
          </div>
     );
};
