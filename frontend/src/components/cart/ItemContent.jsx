...
const ItemContent = ({productId, productName, image, description, quantity, price, discount, specialPrice, cartId}) => {
     ...
     return (
          <div className='grid md:grid-cols-5 grid-cols-4 md:text-md text-sm gap-4 items-center border-[1px] border-slate-200'>
               ...
               <div className='justify-self-center lg:text-[17px] text-sm text-slate-600 font-semiboldssssss'>
