     ...
     return (
          <>
               <Dialog open={open} as='div' className='relative z-10' onClose={close}>
                    <DialogBackdrop transition className='fixed inset-0 bg-gray-500 opacity-75 transition-opacity' />
                                             ...
                                             <div className='flex items-center justify-between gap-2'>
                                                  {specialPrice ? (
                                                       <div className='flex items-center gap-2'>
                                                            ...
                                                            <span className='sm:text-xl font-bold text-slate-700'>
                                                  ...
                                                  {isAvailable ? (
                                                       ...
                                                       <Status text='Out of Stock' icon={MdClose} bg='ng-rose-200' color='text-rose-700' />
                                                  )}
                                             </div>
                                             <Divider />
                                             <p>{description}</p>
