...
public interface ProductService {
    ...
    ProductResponse getAllProductsForAdmin(int pageNumber, int pageSize, String sortBy, String sortOrder);

    ProductResponse getAllProductsForSeller(int pageNumber, int pageSize, String sortBy, String sortOrder);
}
